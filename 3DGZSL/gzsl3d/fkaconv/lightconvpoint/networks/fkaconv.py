...
class FKAConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, segmentation=False, hidden=64, w2v_size=600):
        ...
        if self.segmentation:
            ...
            self.fcout_gen_binary = nn.Conv1d(hidden, 2, 1)
    ...
    # def training_binary_generative(self, xout):
    #     # func = nn.Sigmoid()
    #     # return func(self.fcout_gen_binary(xout))
    #     return self.fcout_gen_binary(xout)
