...
def batch_neighbors(queries, supports, q_batches, s_batches, radius):
    """
    Computes radius_neighbors for a batch of queries and supports
    :param queries: (N1, 3) the query points
    :param supports: (N2, 3) the support points
    :param q_batches: (B) the list of lengths of batch elements in queries
    :param s_batches: (B)the list of lengths of batch elements in supports
    :param radius: float32
    :return: radius_neighbors indices
    """
...
class PointCloudDataset(Dataset):
    ...
    def big_neighborhood_filter(self, neighbors, layer):
        """
        Filter neighborhoods with max number of radius_neighbors. Limit is set to keep XX% of the neighborhoods untouched.
        Limit is computed at initialization
        """

        # crop radius_neighbors matrix
    ...
    def classification_inputs(self,
        ...
        for block_i, block in enumerate(arch):
            ...
            # Convolution radius_neighbors indices
            # *****************************

            deform_layer = False
            if layer_blocks:
                # Convolutions are done in this layer, compute the radius_neighbors with the good radius
                ...
                # This layer only perform pooling, no radius_neighbors required
                conv_i = np.zeros((0, 1), dtype=np.int32)

            # Pooling radius_neighbors indices
            # *************************
            ...
            if 'pool' in block or 'strided' in block:
                ...
                # Radius of pooled radius_neighbors
            ...
            # Reduce size of radius_neighbors matrices by eliminating furthest point
