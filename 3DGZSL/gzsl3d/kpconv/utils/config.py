...
class Config:
    ...
    # Input parameters
    ##################
    #list of ignore labels
    list_idx_ignore = [0, 3, 4, 7, 19]
    baseline = False
    convex_baseline = False 

    #ZSL parameter
    attribute_name = "glove_w2v"
    attribute_size = 600
    ...
    def save(self):
        ...
        with open(join(self.saving_path, 'parameters.txt'), "w") as text_file:
            ...
            #My own parameters
            text_file.write('# -----------------------------------#\n')
            text_file.write('# ZSL parameter #\n')
            text_file.write('# -----------------------------------#\n\n')
            
            
            text_file.write('# list_idx_ignore = {}\n'.format(self.list_idx_ignore))
            text_file.write('# baseline = {}\n'.format(self.baseline))
            text_file.write('# convex_baseline = {}\n'.format(self.convex_baseline))
            text_file.write('# attribute_name = {}\n'.format(self.attribute_name))
            text_file.write('# attribute_size = {}\n'.format(self.attribute_size))
