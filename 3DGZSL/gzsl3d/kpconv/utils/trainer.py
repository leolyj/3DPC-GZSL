...
# PLY reader
from gzsl3d.kpconv.utils.ply import read_ply, write_ply

# Metrics
from gzsl3d.kpconv.utils.metrics import IoU_from_confusions, fast_confusion
...
class ModelTrainer:
    ...
    def __init__(self, net, config, chkp_path=None, finetune=False, on_gpu=True, all_labels=None, unseen_labels=None ):
        """
        ...
        seen_labels =  np.delete(all_labels, unseen_labels).tolist()
        self.valid_labels = torch.from_numpy(np.array(seen_labels)).cuda()
