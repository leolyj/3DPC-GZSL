...
def complete_parser_s3dis():
    ...
    parser.add_argument("--proto_ratio", default=0.04, type=float)
...
def complete_parser_sn():
    ...
    # evaluation option
    parser.add_argument("--eval-interval", type=int, default=5, help="evaluation interval (default: 20)")
    parser.add_argument("--real_seen_features", type=bool, default=True, help="real features for seen classes")
    #Specific size of scannet
    ...
    parser.add_argument("--batch_size", default=4, type=int) # 4, 8
    parser.add_argument("--r", default=0.1, type=float)
    parser.add_argument("--mask_ratio", default=0.2, type=float)
    parser.add_argument("--proto_ratio", default=0.04, type=float)
    parser.add_argument("--temperature", default=0.5, type=float)
...
def complete_parser_sk():
    ...
    parser.add_argument("--checkname", type=str, default="gmmn_context_w2c300_linear_weighted100_hs256_2_unseen")
    # evaluation option
    parser.add_argument("--eval-interval", type=int, default=5, help="evaluation interval (default: 1)")
