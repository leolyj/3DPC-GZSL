...
################################
from gzsl3d.convpoint.convpoint.nn import PtConv
from gzsl3d.convpoint.convpoint.nn.utils import apply_bn
import torch
import torch.nn as nn


class SegBig(nn.Module):
    def __init__(self, input_channels, output_channels, dimension=3, return_ll=False, freeze_bn=False, w2v_size=300,
                 args={}):
