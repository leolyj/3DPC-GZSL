...
sys.path.append('..')
from seg.utils.saver import Saver
from seg.utils.summaries import TensorboardSummary
from seg.modeling.gmmn import GMMNnetwork
from seg.utils.loss import GMMNLoss
